...
time.sleep(1)
see = input('Schau, da ist ein See! Wollen wir durchschwimmen?\n').upper()
time.sleep(1)
if see == 'JA':
    print('HILFE!!! EIN HAI!!')
    print('Ham')
    ...
    time.sleep(1)
    print('Ok, nehmen wir den Waldweg.')
print('Es fängt zu regnen an')
time.sleep(1)
hoehle = input('Siehst du die Höhle dort. Wollen wir dort übernachten?\n').upper()
if hoehle == 'JA':
    print('Ein, Bär!!')
    print('Ham')
    print('GAME OVER')
    ...
    print('Dann lass uns weitergehen.')
